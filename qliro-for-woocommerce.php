...
if ( ! class_exists( 'Qliro_One_For_WooCommerce' ) ) {
	...
	class Qliro_One_For_WooCommerce {
		...
		public function init_gateways() {
			...
			include_once QLIRO_WC_PLUGIN_PATH . '/classes/requests/post/class-qliro-one-request-save-credit-card.php';
			...
			include_once QLIRO_WC_PLUGIN_PATH . '/classes/requests/helpers/class-qliro-one-helper-customer.php';
