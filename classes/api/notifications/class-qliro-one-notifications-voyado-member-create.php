<?php
/**
 * Class for handling the Voyado loyalty provider member create notification from Qliro.
 *
...
/**
 * Class Qliro_One_Notifications_Voyado_Member_Create
 */
class Qliro_One_Notifications_Voyado_Member_Create extends Qliro_One_Notifications {
	/**
