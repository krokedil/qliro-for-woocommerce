<?php
/**
 * Class for handling the Voyado loyalty provider member update notification from Qliro.
 *
...
/**
 * Class Qliro_One_Notifications_Voyado_Member_Update
 */
class Qliro_One_Notifications_Voyado_Member_Update extends Qliro_One_Notifications {
	/**
