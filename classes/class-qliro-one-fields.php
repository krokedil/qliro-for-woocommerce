	...
	public static function fields() {
		...
		$settings = array(
			...
			'checkout_configuration'                     => array(
				...
				'type'        => 'krokedil_section_start',
				'description' => __( 'Configure your checkout in relation to shipping, B2C/B2B purchases, custom checkboxes and risk mitigations.', 'qliro-one-for-woocommerce' ),
			),
			...
			'qliro_one_button_ask_for_newsletter_signup' => array(
				'title'       => __( 'Add custom checkbox to checkout', 'qliro-one-for-woocommerce' ),
				'type'        => 'checkbox',
				'label'       => __( 'Show checkbox in checkout', 'qliro-one-for-woocommerce' ),
				'description' => __( 'If enabled, Qliro Checkout will show a custom checkbox in the checkout iframe. Read more about how you can use the response from this field <a target="_blank" href="https://docs.krokedil.com/qliro-for-woocommerce/get-started/newsletter-settings/">here</a>.', 'qliro-one-for-woocommerce' ),
				'default'     => 'no',
				'desc_tip'    => false,
			...
			'qliro_one_button_ask_for_newsletter_signup_label' => array(
				'title'       => __( 'Custom checkbox label', 'qliro-one-for-woocommerce' ),
				'type'        => 'text',
				'label'       => __( 'Custom checkbox label', 'qliro-one-for-woocommerce' ),
				'description' => __( 'Customize the label for the custom checkbox.', 'qliro-one-for-woocommerce' ),
			...
			'qliro_one_button_ask_for_newsletter_signup_checked' => array(
				'title'       => __( 'Custom checkbox checked by default', 'qliro-one-for-woocommerce' ),
				'type'        => 'checkbox',
				'label'       => __( 'Set custom checkbox as checked by default', 'qliro-one-for-woocommerce' ),
				'description' => __( 'If enabled, Qliro Checkout will set the custom checkbox as checked by default.', 'qliro-one-for-woocommerce' ),
				'default'     => 'no',
				'desc_tip'    => true,
				'class'       => 'krokedil_conditional_setting krokedil_conditional_newsletter_settings',
			),
			...
			'calculate_return_fee'                       => array(
				...
				'label'       => __( 'Automatically calculate return fee on refunds', 'qliro-one-for-woocommerce' ),
				'type'        => 'checkbox',
				'default'     => 'no',
