...
class Qliro_One_Assets {
	...
	public function enqueue_admin_order_script( $hook ) {
		...
		$params = array(
			...
			'return_fee_manual_refund_text'           => __( 'A return fee only applies when refunding via Qliro. Remove the return fee or use "Refund via Qliro".', 'qliro-for-woocommerce' ),
			'i18n'                                    => array(
