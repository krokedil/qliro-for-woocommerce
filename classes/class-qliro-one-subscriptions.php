...
class Qliro_One_Subscriptions {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_receipt_' . self::GATEWAY_ID, array( $this, 'display_add_card_on_receipt_page' ) );
	}
	 ...
	 * @return void
	 */
	public function display_add_card_on_receipt_page( $order_id ) {
	 ...
	 */
	public static function get_add_card_receipt_page_url( $order ) {
	 ...
	 */
	public static function get_change_card_confirmation_url( $subscription ) {
