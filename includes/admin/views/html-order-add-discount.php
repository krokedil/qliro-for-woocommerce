	...
	<div class="wc-backbone-modal wc-order-preview">
		<div class="wc-backbone-modal-content" tabindex="0">
			<section class="wc-backbone-modal-main" role="main">
				...
				<article id="qliro-discount-form" style="max-height: 851.25px;" data-fees="<?php esc_attr_e( $qliro_discount_data['fees'] ); ?>" data-total-amount="<?php esc_attr_e( $qliro_discount_data['total_amount'] ); ?>" data-available-amount="<?php esc_attr_e( wc_format_decimal( $qliro_discount_data['available_amount'] ) ); ?>">
				...
				<footer>
					<div class="inner">
						...
						<button type="submit" disabled id="qliro-discount-form-submit" class="button button-primary button-large" aria-label="<?php esc_attr_e( 'Confirm', 'qliro-one-for-woocommerce' ); ?>" formaction="<?php echo esc_url( $qliro_discount_data['action_url'] ); ?>"><?php esc_html_e( 'Confirm', 'qliro-one-for-woocommerce' ); ?></button>
					</div>
				</footer>
			</section>
		</div>
