...
<div class="wc-order-data-row wc-order-partial-capture wc-order-data-row-toggle" style="display: none;">
	...
	<div class="capture-actions">
		<button type="button" class="button button-primary do-capture tips" data-tip="<?php esc_attr_e( 'This will create a capture for this order.', 'qliro-one-for-woocommerce' ); ?>"><?php printf( esc_html__( 'Create Capture', 'qliro-one-for-woocommerce' ) ); ?></button>
